        ...
        <div className={styles.root}>
            ...
            <Layout moduleData={moduleData}>
                ...
                >
                    ...
                    <Label {...moduleData.labelData} text="Header Module" gap={false} />
...
"
                    ...
                    <Label {...moduleData.labelData} text="List Module" gap={false} />
...
</ul><br><b>Layouts </b><br><u>Article Layout:</u> Shows larger image and text alongside each other <br><u>Card Layout:</u> Narrower banner version, with color on sides<br>
